...
function Load_OUTCASH() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureOutcashBack),
    }),
  ];
...
function Load_PES94() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Left),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Right),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Top),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Bottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Front),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(texturePes94Back),
    }),
  ];
...
function Load_HORMONA() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureHormonaBack),
    }),
  ];
...
function Load_RIO() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureRioBack),
    }),
  ];
...
function Load_GANDARA() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureGandaraBack),
    }),
  ];
...
function Load_SK() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureSKBack),
    }),
  ];
...
function Load_BIRICIA() {
  ...
  var material = [
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaLeft),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaRight),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaTop),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaBottom),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaFront),
    }),
    new THREE.MeshBasicMaterial({
      map: new THREE.TextureLoader().load(textureBiriciaBack),
    }),
  ];
